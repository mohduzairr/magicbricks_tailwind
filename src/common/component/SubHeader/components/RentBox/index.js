...
export const RentBox = ({setRenthide}) => {
  return (
      <>
          <div onMouseEnter={()=>setRenthide(true)} onMouseLeave={()=>setRenthide(false)} className="lg:h-72 shadow-4xl border-t-white border-2 rounded-2xl border-bordergrey lg:w-[60rem] bg-white mt-14 ml-44 flex justify-around fixed">
           <div className="mt-6 ">
