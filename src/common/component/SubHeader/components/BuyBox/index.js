...
export const BuyBox = ({setBuyhide}) => {
  return (
      <>
        <div onMouseEnter={()=>setBuyhide(true)} onMouseLeave={()=>setBuyhide(false)} className="lg:h-72 shadow-4xl border-t-white border-2 rounded-2xl border-bordergrey lg:w-[60rem] bg-white mt-14 ml-6 flex justify-around fixed">
           <div className="mt-6 ">
