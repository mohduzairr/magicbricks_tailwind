...
export const SellBox = ({setSellhide}) => {
  return (
      <>
          <div onMouseEnter={()=>setSellhide(true)} onMouseLeave={()=>setSellhide(false)} className="lg:h-72 shadow-4xl border-t-white border-2 rounded-2xl border-bordergrey lg:w-[48rem] bg-white mt-14 ml-72 flex justify-around fixed">
           <div className="mt-6 ">
