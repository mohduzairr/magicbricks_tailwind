    ...
    return (
        ...
        <div className="lg:w-full h-12 bg-red flex justify-between lg:items-center sm:w-full md:w-full sm:items-center">
            <div className="flex lg:ml-36 pl-12  md:ml-10">
                ...
                <div onMouseEnter={()=>setCtyhide(true)} onMouseLeave={()=>setCtyhide(false)} className="text-lg text-white ml-12 pt-1 font-light"> <span >City</span> { ctyhide==false ? <i  class="fa fa-caret-down text-white"></i> : <i  class="fa fa-caret-up text-white "></i> }</div>
            </div>
